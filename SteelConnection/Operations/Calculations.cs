            ...
            public class Component2Calculator
            {
                ...
                public class Component7Calculator
                {
                    ...
                    public class Component3Calculator
                    {
                        ...
                        /// <summary>
                        /// Calculates the resistance of an individual bolt row for the column web in tension (Component 3) according to Eurocode 03.
                        /// </summary>
                        /// <param name="profile">Profile object containing geometric and material properties.</param>
                        /// <param name="l_eff_fc">Effective length l_eff,fc for the bolt row.</param>
