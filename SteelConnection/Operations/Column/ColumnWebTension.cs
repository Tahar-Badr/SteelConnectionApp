...
{
    internal class ColumnWebTension
    {
        public static class ColumnWebTension
        {
            public static class ResistanceResults
            {
                ...
                int boltRows, bool isFirstRow = false)
            {
                ...
                {
                    // 4-row requires group effect calculations
                    // 1. Individual rows (identical for rows 1-3)
                    ...
                    // 2. Group 1+2 (circular and non-circular patterns)
                    ...
                    // 3. Group 1+2+3 (only non-circular pattern)
            ...
            // Helper to determine governing resistance considering group effects
