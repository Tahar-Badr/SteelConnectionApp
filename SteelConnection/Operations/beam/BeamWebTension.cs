...
{
    internal class BeamWebTension
    {
        public static class BeamWebTension
        {
            /// <summary>
                ...
                double b_eff_group) // Effective width for group (mm)
            {
                ...
                results.Row2Individual = (b_eff_row2 * t_wb * f_ywb) / SafetyFactors.GammaM0;
                results.Row3Individual = (b_eff_row3 * t_wb * f_ywb) / SafetyFactors.GammaM0;

                // Group resistance (rows 2+3)
                results.Rows2And3Group = (b_eff_group * t_wb * f_ywb) / SafetyFactors.GammaM0;
